...
function title() {
      console.clear()
	  console.log(chalk.bold.green(figlet.textSync('Joze - Bot', {
		font: 'Standard',
	...
	console.log(chalk.yellow(`\n                        ${chalk.yellow('[ Powered By Dudul ]')}\n\n${chalk.red('Joze - Bot')} : ${chalk.white('WhatsApp Bot Multi Device')}\n${chalk.red('Follow Insta Dev')} : ${chalk.white('@-')}\n${chalk.red('Message Me On WhatsApp')} : ${chalk.white('6283171382342')}\n${chalk.red('Donate')} : ${chalk.white('0821 2828 0049 ( Gopay/Pulsa )')}\n`))
}
